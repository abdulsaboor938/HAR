...
automl_run_id = 'good_tent_22m6p2my95_0'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_uri', type=str, default='azureml://locations/southindia/workspaces/d07e0a61-1ff4-4fd9-8c57-3562a388ae2c/data/HAR/versions/1',     help='Default training dataset uri is populated from the parent run')
